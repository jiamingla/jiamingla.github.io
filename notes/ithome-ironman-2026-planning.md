...
### Ming disclosure 腳本（2026-07-09 校準）

> 校準重點：①inform 不 ask permission（committed action）②主題軟化，不講「我要當 QA Head」③**用真在做的 smoke 框架當 build 佐證**（7/03：build 動機、不是 prove）④role-modeled framing「RD 端有、QA 端缺」⑤結尾把 Ming 從傳達者變 advisor。

> 「Ming，先跟你講一件事——我報名了鐵人賽，下班時間做，9 月連續 30 天發文。
>
> 內容大概是我這幾年在做的東西 + 一些觀察：測試方法論（PDT），還有 QA 在組織裡可以多做什麼。我最近剛好在整理一套跨 App 的冒煙測試框架，也想把這些整理成一份對外的紀錄。
>
> 背後的想法我也想跟你講白：我一直很欣賞 RD Head 那種『跟產品綁很深、又帶著團隊把事做成』的角色，想試試在 QA 這邊 build 一個對應的版本——所以也在看管理相關的系所，鐵人賽會是其中一塊 portfolio。這方向公司 QA 端還沒人做過，**想聽聽你的看法。**」
>
> → 結尾追加：「**你建議我什麼時候、用什麼方式跟 Coin 提比較好？還是你會自然跟他提？**」

> ⚠️ 校準後仍要注意：smoke 框架**目前還沒正式跟主管報告過**（見 skeletons/coach 紀錄）——這次 disclosure 剛好是「把已經在 build 的東西講出來」的第一步，呼應〈對的工具用錯時機〉：不必先對齊才有資格講你做了什麼。
