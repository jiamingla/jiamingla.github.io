...
> **線六近期密度警示**：2026-05-12 起的 PDT Coach 四場 session 累計孕育 **13 個**自省 / 大人學題目。**這條線已嚴重過熱**——寫的時候務必分散到其他線、不要連發，否則部落格會給人「自省過載 / 心靈雞湯」的觀感。建議跟線一（PDT 哲學）、線四（方法論）、線三（技術實戰）輪流發；同時間發兩篇線六的話兩篇至少要相隔 3-4 週。
...
| 2 | **letter-to-new-qa-two-day-regression** | 線四 測試紀律 | 跨線換調性（從 AI 議題回到紮實方法論），roadmap 早已標「下一篇想這個方向」(5/11) 但被延遲。**目標發稿：5/24-5/25** |
