...
- [2026-05-31-brand-value-and-smoke-test-proposal.md](coach-sessions/2026-05-31-brand-value-and-smoke-test-proposal.md) — **品牌價值與冒煙測試提案**（異常處理價值 / 向上管理劇本 / 技術與業務共生策略）
