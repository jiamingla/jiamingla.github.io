...
title: 問題驅動測試（PDT）：致命 Bug 藏在你沒問過的問題裡
date: 2026-04-24 19:00:00
...
- **擴散**：不論結果對錯，都讓它**生出下一個該問的問題**

這是「**怎麼想**」的節奏，會持續循環跑，直到你對模組的不確定性下降到可接受程度。至於**想什麼**——也就是具體該問哪些問題——留到第五節再給你可直接帶走的提問模板。
